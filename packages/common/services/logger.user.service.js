...
exports.LoggerUserService = void 0;
...
class LoggerUserService {
    ...
    log(color, level, message, arg, ...otherArg) {
        if ((0, shared_utils_1.coerceBooleanProperty)(process.env.ZANOBIJS_LOGGER_USER))
...
exports.LoggerUserService = LoggerUserService;
